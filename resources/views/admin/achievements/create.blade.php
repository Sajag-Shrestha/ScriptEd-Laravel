...
<head>
    @include('layout/head')
    <title>Add Achievement | ScriptEd</title>
</head>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select id="type"
                                                    ...
                                                    <option value="Module Completed"
                                                        {{ old('type') == 'Module Completed' ? 'selected' : '' }}>Module
                                                        Completed</option>
                                                    <option value="Time Spent"
                                                        {{ old('type') == 'Time Spent' ? 'selected' : '' }}>Time Spent
                                                    </option>
                                                </select>
                                                @error('type')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description"
                                                    placeholder="Enter achievement description" rows="4">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3 criteria-module-wrapper" style="display:none;">
                                                ...
                                                <select id="criteria_module"
                                                    ...
                                                    <option value="" disabled
                                                        {{ old('criteria_module') ? '' : 'selected' }}>Select Module
                                                    </option>
                                                    @foreach ($modules as $module)
                                                        <option value="{{ $module->id }}"
                                                            {{ old('criteria_module') == $module->id ? 'selected' : '' }}>
                                                            {{ $module->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
